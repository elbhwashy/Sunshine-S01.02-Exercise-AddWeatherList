...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView wheatherTevtView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wheatherTevtView = (TextView)findViewById(R.id.tv_weather_data);
        // Done (3) Create an array of Strings that contain fake weather data
        String [] fakeWeatherData = {"dvjsdvv","jsdfdsf","dfjksdsfv","djkfbsdhgnsdbn","djfbhsdhvbsdn","jfbvhgsdvsd"};
        // Done (4) Append each String from the fake weather data array to the TextView

        for(int i = 0; i < fakeWeatherData.length; i++ ){
            wheatherTevtView.append(fakeWeatherData[i] + "\n\n\n");
